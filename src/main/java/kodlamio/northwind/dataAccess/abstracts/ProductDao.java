package kodlamio.northwind.dataAccess.abstracts;
...
public interface ProductDao extends JpaRepository<Product,Integer> {
    ...
    @Query("Select new kodlamio.northwind.entities.concretes.dtos.ProductWithCategoryDto(p.id, p.productName, c.categoryName ) From Category c Inner Join c.products p")
